...
static void RenderSceneCB()
{
    ...
    Pipeline p;
    p.Rotate(0.0f, Scale, 1.0f);//Вращение треугольника в пространстве
    p.WorldPos(0.0f, 0.0f, 0.0f);//позиция треугольника в пространстве, sin\cos(Scale) для перемещения треугольника по осям X Y Z
    Vector3f CameraPos(0.0f, 0.0f, -3.0f);//Положение камеры относительно осей X Y Z 
    ...
    glDrawElements(GL_TRIANGLES, 12, GL_UNSIGNED_INT, 0);//выбор фигуры и указание количества вершин
...
{
    Vector3f Vertices[4];//Матрица вершин треугольника
...
int main(int argc, char** argv)
{
    ...
    glutInitWindowPosition(100, 15);//Позиция окна
    glutCreateWindow("Tutorial 13");//Название окна
