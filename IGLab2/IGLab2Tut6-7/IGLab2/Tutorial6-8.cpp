...
static void RenderSceneCB()
{
    ...
    Scale += 0.0001f; //Скорость передвижения фигуры
    ...
    //[1][3] - Y 
    //[2][3] - Z
    //[1][3] - позиция треугольника по вертикали
    //[3][3] - положение камеры относительно треугольника
    //Туториал 6 - Перемещение треугольника по оси X 
...
//---------------------------------------------------------------------------------------------------------------
    ...
    //Туториал 7 - Матрица вращения треугольника
...
//---------------------------------------------------------------------------------------------------------------
    ...
    //Туториал 8 - Матрица преобразования масшатаба треугольника
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Tutorial 07"); //Название окна
